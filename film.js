...
const vybranyFilm = filmy.find(film => film.id === location.hash.slice(1));

// if (vybranyFilm) {
// Získání elementů, do kterých chceme vepsat informace
const filmDescriptionElm = document.querySelector('#detail-filmu');

const nazevElement = filmDescriptionElm.querySelector('.card-title');
const plakatElement = filmDescriptionElm.querySelector('.img-fluid');
const popisElement = filmDescriptionElm.querySelector('.card-text');
